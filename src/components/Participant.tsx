        ...
        <div className="participant pt-[50px] pb-[50px]">
            <div className="flex flex-col justify-evenly items-center md:flex-row">
                <div className="flex flex-col items-center pb-5">
                    <h1 className="text-5xl font-bold text-red-600">450K+</h1>
                    <h2 className="pt-2 text-2xl text-red-500">Recipes</h2>
                </div>
                <div className="flex flex-col items-center pb-5">
                    <h1 className="text-5xl font-bold text-red-600">800+</h1>
                    <h2 className="pt-2 text-2xl text-red-500">Cities</h2>
                </div>
                <div className="flex flex-col items-center pb-5">
                    <h1 className="text-5xl font-bold text-red-600">5000+</h1>
